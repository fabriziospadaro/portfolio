...
function move(elem, elem2) {
    let width = 1;
    let limit = elem2.innerHTML.split(" ")[1];
    let start_var = elem2.innerHTML.split(" ")[0];
    ...
    function frame() {
        if (width >= limit) {
            ...
            width++;
            elem2.innerHTML = start_var + " " + width + '%';
...
function RecursiveBarUpdater() {
    let elements = document.querySelectorAll(".custom-progress");
    let elements2 = document.querySelectorAll(".progress-text");
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-0d57a814b57609c1a0e8.js.map