...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_animejs__ = __webpack_require__(/*! animejs */ 15);
...
function move(elem, elem2) {
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()(elem).fadeToggle(1000);
  let width = 1;
  let limit = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(elem2).html().split(" ")[1];
  let start_var = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(elem2).html().split(" ")[0];
  ...
  function frame() {
    if (width >= limit) {
      ...
      width++;
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()(elem2).html(start_var + " " + width + '%');
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()(elem).css({ width: width + '%' });
    }
  }
}

function RecursiveBarUpdater() {
  let elements = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".custom-progress");
  let elements2 = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".progress-text");
  for (let i = 0; i < elements.length; i++) {
    __WEBPACK_IMPORTED_MODULE_1_jquery___default()(elements[i]).toggle();
...
var Messenger = function (el) {
  ...
  m.init = function () {
    m.codeletters = "qwertyuiopasdfghjklzxcvbnmè+òàù1234567890'''ì";
    m.current_length = 0;
    m.fadeBuffer = false;
    m.message = __WEBPACK_IMPORTED_MODULE_1_jquery___default()(el).html();
  ...
  m.animateIn = function () {
    if (m.current_length < m.message.length) {
      ...
      __WEBPACK_IMPORTED_MODULE_1_jquery___default()(el).html(message);
  ...
  m.animateFadeBuffer = function () {
    if (m.fadeBuffer === false) {
      ...
      for (var i = 0; i < m.message.length; i++) {
        m.fadeBuffer.push({ c: Math.floor(Math.random() * 4) + 1, l: m.message.charAt(i) });
      }
    }
...
let msgs = __WEBPACK_IMPORTED_MODULE_1_jquery___default()('p');
msgs.push(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('h1'));
msgs.push(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('h3'));
msgs.push(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('h2'));

for (let i = 0; i < msgs.length; i++) {
  let messenger = new Messenger(msgs[i]);
}

__WEBPACK_IMPORTED_MODULE_1_jquery___default()(".selection-bar").toggle();

__WEBPACK_IMPORTED_MODULE_1_jquery___default()(".nav-bar").on("click", function () {
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".selection-bar").fadeToggle(500);
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".nav-bar").slideUp(200);
});

__WEBPACK_IMPORTED_MODULE_1_jquery___default()(".close-nav-bar").on("click", function () {
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".selection-bar").fadeToggle(500);
  __WEBPACK_IMPORTED_MODULE_1_jquery___default()(".nav-bar").slideDown(200);
});
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-34087f9190fd90dd5036.js.map